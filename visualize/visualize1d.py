...
def visualize1d(x=None, y=None, y_noisy=None, x_test=None, predictive_mean=None, predictive_var=None, filename=None):
    ...
    assert all([y is not None, y_noisy is not None]), "Please provide either true function evaluations, y or the noisy ones y_noisy."
    ...
    plt.fill_between(x_test.flatten(), predictive_mean - 2 * pred_std, predictive_mean + 2 * pred_std, color="b", alpha=0.2, label="Two standard deviations")
